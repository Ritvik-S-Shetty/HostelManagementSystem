                   ...
                   <div class="row">
                     <div class="col">
                        <center>
                            ...
                            <asp:Label ID="Label1" class="badge badge-info" runat="server" Text="Label"></asp:Label>
                        </center>
                     </div>
                  </div>
                     ...
                     <div class="col-8 mx-auto">
                        <div class="form-group">
                            <center>
                                ...
                                <asp:Button ID="Button1" class="btn btn-primary btn-lg btn-block"  runat="server" Text="Update" OnClick="Button1_Click" />
                            </center>
                        </div>
